  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-12">
        <Card className="md:col-span-8 border-white/10 shadow-lg relative overflow-hidden group bg-[#111]">
        ...
        <Card className="md:col-span-4 border-none shadow-xl bg-[#c9352e] text-white flex flex-col justify-center items-center text-center p-8 relative overflow-hidden">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Mini Leaderboard */}
        <Card className="lg:col-span-1 bg-[#111] border-white/10">
