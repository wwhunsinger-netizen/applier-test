...
export default function DashboardPage() {
  ...
  const percentComplete =
    stats.dailyGoal > 0 ? (stats.dailyApps / stats.dailyGoal) * 100 : 0;
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground pt-1">
                    ...
                    <span className="font-medium text-white">
                      {stats.dailyGoal - stats.dailyApps} more
                    </span>{" "}
                    needed for your{" "}
              ...
              <div className="relative z-10 space-y-6 w-full flex flex-col items-center">
                ...
                <div className="space-y-2">
                  <h3 className="text-3xl font-bold">
                    {stats.jobsWaiting} Jobs Waiting
                  </h3>
                ...
                <Link href="/queue" className="w-full">
                  <Button
                    size="lg"
                    className="w-full bg-white text-[#c9352e] hover:bg-white/90 font-bold shadow-xl h-12 text-base tracking-wide uppercase transition-transform hover:scale-[1.02]"
                  >
                    START REVIEWING
                  </Button>
                </Link>
          ...
          <Card className="h-full bg-[#111] border-white/10">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                ...
                <span className="font-mono font-bold text-white">
                  ${stats.estimatedBasePay.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                <span className="text-sm text-muted-foreground">
              ...
              <div className="flex justify-between items-center py-2 bg-white/5 rounded-lg px-3 -mx-3">
                ...
                <span className="font-mono font-bold text-xl text-primary">
                  ${(stats.estimatedBasePay + stats.dailyEarnings).toFixed(2)}
                </span>
              </div>
              <div className="pt-2 text-xs text-muted-foreground">
                Base pay: $7/hr | Bonuses: $25 at 100 apps, $50/interview,
                $400/placement
              </div>
            </CardContent>
          </Card>
